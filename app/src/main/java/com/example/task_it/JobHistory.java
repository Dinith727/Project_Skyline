...
public class JobHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readRef.orderByChild("emp").equalTo("741852963").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull  DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    Toast.makeText(getApplicationContext(), "WADA ", Toast.LENGTH_SHORT).show();
...
//    RecyclerView rv;
//    DatabaseReference database;
//    com.example.task_it.JobAdapter jobAd;
...
//        setContentView(R.layout.activity_job_history);
//        rv = findViewById(R.id.jobList);
//        database = FirebaseDatabase.getInstance().getReference().child("Job");
//        rv.setHasFixedSize(true);
//        rv.setLayoutManager(new LinearLayoutManager(this));
//        list = new ArrayList<>();
//        jobAd = new JobAdapter(this, list);
//        rv.setAdapter(jobAd);
//
//
//
