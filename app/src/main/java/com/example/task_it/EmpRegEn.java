...
public class EmpRegEn extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = (Spinner)findViewById(R.id.catSpin88);
        ...
        name = findViewById(R.id.rthth88);
        nic = findViewById(R.id.addconpw5588);
        email = findViewById(R.id.txtemail188);
        phone = findViewById(R.id.txtphone188);

        submit = findViewById(R.id.savechan);
        emp = new Employee();
